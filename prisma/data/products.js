...
exports.getCategoryIdFromName = exports.matchProductToCategory = exports.categories = exports.products = void 0;
// Función para calcular si un producto está en stock
const calculateInStock = (stock) => stock > 0;
exports.products = [
    {
        id: '1',
...
const matchProductToCategory = (productCategory, categoryId) => {
...
exports.matchProductToCategory = matchProductToCategory;
// Helper function to get category ID from category name
const getCategoryIdFromName = (categoryName) => {
    const categoryNameLower = categoryName.toLowerCase();
    if (categoryNameLower === 'papelería')
        return 'papeleria';
    if (categoryNameLower === 'cotillón')
        return 'cotillon';
    if (categoryNameLower === 'manualidades')
        return 'manualidades';
    if (categoryNameLower === 'decoración')
        return 'decoracion';
    return categoryNameLower;
};
exports.getCategoryIdFromName = getCategoryIdFromName;
