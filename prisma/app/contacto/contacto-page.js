      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 p-6 bg-brand-fondoSec rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                  <div className="bg-brand-acento p-3 rounded-full">
                    <lucide_react_1.Mail className="h-6 w-6 text-white"/>
                  </div>
                  <div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-brand-fondoSec rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                  <div className="bg-brand-acento p-3 rounded-full">
                    <lucide_react_1.Clock className="h-6 w-6 text-white"/>
                  </div>
                  <div>
          ...
          <div className="bg-brand-fondoSec rounded-2xl shadow-lg p-8">
            ...
            {submitStatus === 'success' && (<div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center">
                  <lucide_react_1.CheckCircle className="h-5 w-5 text-green-500 mr-2"/>
            ...
            {submitStatus === 'error' && (<div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                <div className="flex items-center">
                  <lucide_react_1.AlertCircle className="h-5 w-5 text-red-500 mr-2"/>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-acento ${errors.name ? 'border-red-500' : 'border-gray-300'} text-brand-principal`} placeholder="Tu nombre completo"/>
              ...
              <div>
                ...
                <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-acento ${errors.email ? 'border-red-500' : 'border-gray-300'} text-brand-principal`} placeholder="tu@email.com"/>
              ...
              <div>
                ...
                <select id="subject" name="subject" value={formData.subject} onChange={handleChange} className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-acento ${errors.subject ? 'border-red-500' : 'border-gray-300'} text-brand-principal`}>
              ...
              <div>
                ...
                <textarea id="message" name="message" value={formData.message} onChange={handleChange} rows={5} className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-acento ${errors.message ? 'border-red-500' : 'border-gray-300'} text-brand-principal`} placeholder="Escribe tu mensaje aquí..."/>
                {errors.message && (<p className="text-red-500 text-sm mt-1">{errors.message}</p>)}
              </div>

              <button type="submit" disabled={isSubmitting} className="w-full bg-brand-acento text-white py-3 px-6 rounded-lg hover:bg-brand-principal transition-colors shadow-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center">
                {isSubmitting ? (<>
